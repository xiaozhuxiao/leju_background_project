    ...
    <el-card shadow="neveralwys" class="margin-30">
      ...
      <el-table :data="articleList" border style="width: 100%" stripe>
        ...
        <el-table-column prop="editorType" label="编辑器类型" width="200" align="center">
          <template slot-scope="scope">
            <el-button v-if="scope.row.editorType == 0" type="primary" size="small">富文本</el-button>
            <el-button v-if="scope.row.editorType == 1" type="primary" size="small">markdown</el-button>
          </template>
        </el-table-column>
