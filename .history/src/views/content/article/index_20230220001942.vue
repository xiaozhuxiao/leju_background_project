<template>
  <div class="article-main">
    ...
    <el-card shadow="neveralwys" class="margin-30">
      ...
      <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange" :current-page.sync="start" :page-sizes="[10, 20, 30, 40]" :page-size="limit" layout="total, sizes, prev, pager, next, jumper" :total="totalNum" style="margin-top: 10px; text-align: right"> </el-pagination>
    </el-card>
  </div>
</template>
