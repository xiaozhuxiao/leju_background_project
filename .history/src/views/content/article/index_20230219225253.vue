  ...
  <div class="article-main">
    ...
    <el-card shadow="neveralwys" class="margin-30">
      ...
      <el-table :data="articleList" border style="width: 100%" stripe>
        <el-table-column fixed type="index" :index="indexMethod" label="#" width="80" align="center"> </el-table-column>
        ...
        <el-table-column prop="editortype" label="编辑器类型" width="200" align="center">
          <template slot-scope="scope">
            <el-button v-if="scope.row.editorType == 0" type="primary" size="defaule">富文本</el-button>
            <el-button v-if="scope.row.editorType == 1" type="primary" size="defaule">markdown</el-button>
          </template>
        </el-table-column>
        <el-table-column fixed="right" label="操作" width="200">
          <template slot-scope="scope">
            <el-button @click="handleClick(scope.row)" type="primary" size="small">编辑文章</el-button>
