<template>
  <div class="article-main">
    <el-card shadow="never" class="box-card margin-30">
      ...
      <!-- 文章列表 -->
      <el-table :data="tableData" border style="width: 100%" border align="center">
        <el-table-column fixed prop="date" label="#" width="80"> </el-table-column>
        <el-table-column prop="name" label="文章标题" width="120"> </el-table-column>
        <el-table-column prop="province" label="展示图片" width="120"> </el-table-column>
        <el-table-column prop="city" label="添加时间" width="120"> </el-table-column>
        <el-table-column prop="address" label="文章作者" width="200"> </el-table-column>
        <el-table-column prop="zip" label="文章是否展示" width="120"> </el-table-column>
        <el-table-column prop="zip" label="内容" width="120"> </el-table-column>
