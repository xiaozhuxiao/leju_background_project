<template>
  <div class="article-detail-main">
    <el-card shadow="never" class="margin-30">
      ...
      <el-form :model="article" ref="articleForm" :rules="rules" label-width="80px" size="normal">
        <el-row :gutter="20">
        ...
        <el-row :gutter="20">
          <el-col :span="13" :offset="0">
            <el-form-item label="切换富文本类型">
              <el-radio v-model="radio" label="1">富文本</el-radio>
              <el-radio v-model="radio" label="2">markdown</el-radio>
