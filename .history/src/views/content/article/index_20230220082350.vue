  ...
  <div class="article-main">
    ...
    <el-card shadow="neveralwys" class="margin-30">
      ...
      <el-table v-loading="loading" :data="articleList" border style="width: 100%" stripe>
        <el-table-column fixed type="index" label="#" width="100" align="center"> </el-table-column>
        <el-table-column prop="title" label="文章标题" width="300" align="center"> </el-table-column>
        <el-table-column label="展示图片" width="300" align="center">
        ...
        <el-table-column prop="author" label="文章作者" width="300" align="center"> </el-table-column>
      ...
      <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange" :current-page.sync="start" :page-sizes="[10, 20, 30, 40]" :page-size="limit" layout="total, sizes, prev, pager, next, jumper" :total="totalNum" style="margin-top: 30px; text-align: right"> </el-pagination>
    </el-card>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    getArticleList() {
      this.loading = true
      findArticlesApi(this.start, this.limit).then((res) => {
        console.log(res)
